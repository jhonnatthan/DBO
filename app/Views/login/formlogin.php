<div class="container-fluid h-100">
    <div class="row h-100 justify-content-center align-items-center">
        <div class="col-md-5 col-xs-12 p-4 m-1 mb-4 bg-white rounded shadow-xs animated fadeInLeft">
        ...
        <div class="col-md-4 col-xs-12 p-5 m-1 mb-4 bg-primary text-white rounded align-self-center shadow-xs animated fadeInRight">
