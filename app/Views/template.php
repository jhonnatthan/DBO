...
<html lang="pt-br">
    <head>
        ...
        <title>Diário de Bordo Online</title>
        <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
        <link href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.min.css" rel="stylesheet" >
        <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo HOST_PATH; ?>/css/style.css" rel="stylesheet">
    </head>
    ...
    <script src="<?php echo HOST_PATH; ?>js/ie10-viewport-bug-workaround.js"></script>
    <script src="<?php echo HOST_PATH; ?>js/index.js"></script>
